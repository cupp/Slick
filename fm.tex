...
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.59) p $\Rightarrow$ q $\equiv$ $\neg$p $\vee$ q }\ $\Ggg$ \\
...
true \wedge (q \vee r) \equiv (true \wedge q) \vee (true \wedge r)
false \wedge (q \vee r) \equiv (false \wedge q) \vee (false \wedge r)
