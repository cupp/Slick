...
\begin{tabbing}
99.\;\=(m)\;\=\kill
\underline{Exercise 8.3a}\\\\

\Step{(\star x \dr 0 \leq x + r < n : x + 3)}
...
\underline{Exercise 8.3b}\\\\

\Step{(\star x \dr 0 \leq x + r < n : x + v)}
...
\underline{Exercise 8.3c}\\\\

\Step{(\star y \dr 0 \leq y + r < n + x : y + v)}
...
\underline{Exercise 8.3d}\\\\

\Step{(\star z \dr 0 \leq z < r : (\star w \dr 0 \leq w : z + w + x + y))}
...
\underline{Exercise 8.3e}\\\\

\Step{(\star x \dr 0 \leq x < y : (\star y \dr 0 \leq y : x + y + n))}
